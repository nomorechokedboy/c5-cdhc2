...
CREATE INDEX IF NOT EXISTS `exam_classes_major_idx` ON `exam_classes` (`major_id`);
CREATE INDEX IF NOT EXISTS `exam_classes_faculty_idx` ON `exam_classes` (`faculty_id`);

-- faculty_id trên ngành đào tạo (chạy tay nếu cột chưa có):
-- ALTER TABLE exam_majors ADD COLUMN faculty_id integer;
