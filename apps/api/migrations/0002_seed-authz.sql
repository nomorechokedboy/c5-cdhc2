...
'actions',
'Hành vi',
'Tài nguyên này liên quan tới các hành vì trên các tài nguyên'
),
(
'resources',
'Tài nguyên',
...
VALUES(
'super_admin',
'Siêu quản trị viên - Toàn quyền trên hệ thống'
),
(
'admin',
...
(
'battalion_commander',
'Chỉ huy tiểu đoàn - Quản lý tiểu đoàn'
),
(
'company_commander',
'Chỉ huy đại đội - Quản lý đại đội'
),
(
'viewer',
'Người xem - Chỉ xem thông tin'
);
--> statement-breakpoint
...
DROPTRIGGERIFEXISTSassign_permission_to_super_admin;
CREATETRIGGERassign_permission_to_super_admin AFTERINSERT
ON permissionsBEGININSERT INTO role_permissions(
role_id,
permission_id
)SELECT
(
